...
| Date | Change | Impact |
|---|---|---|
| 2026-08-13 | Homepage recipes and gluten articles made offline-resilient | After the first successful load, cached previews render immediately during outages and refresh from Supabase when available; previously viewed public content images use a bounded PWA cache and homepage dependency chunks are precached for offline restarts |
